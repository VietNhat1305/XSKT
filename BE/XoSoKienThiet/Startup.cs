    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         ...
         string secretKey = "UKnz2ype9MTCKNZqH2wbFcxS1Vph7ncx";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "XoSoKienThiet.WebAPI", Version = "v1" });
            });
                ...
                options.AddPolicy("CorsPolicy",
                    builder => builder
                        ...
                        .WithOrigins(
                            ...
                            "http://localhost:8014",
                            "http://127.0.0.1:5500",
                            "https://test.dongthap.gov.vn",
                            "https://demoxoso.dongthap.gov.vn",
                            "http://xsktdongthap.vn",
                            "https://xsktdongthap.vn"
                        )
                        .AllowCredentials()
                );
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "XoSoKienThiet.WebAPI v1"));
            }
