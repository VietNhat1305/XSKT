...
namespace XoSoKienThiet.Exceptions
{
    public class ResponseMessageException : Exception
    {
        ...
        public ResponseMessageException WithException(int resultCode)
        {
            ...
            switch (ResultCode)
            {
                ...
                case 23 :
                    ...
                    break;
                case 24 :
                    this.ResultString = DefaultMessage.ERROR_STRUCTURE;
                    break;
                case 25 :
                ...
                case 29 :
                    ...
                    break;
                case 30:
                    this.ResultString = DefaultMessage.DELETE_DATA_BEFORE_DELETING_MENU;
                    break;
                case 1 :
        ...
        {
            if (message != null && message.Errors != null)
            {
                this.ResultCode = DefaultCode.DATA_FIELDS_NOT_INCORRECT;
                this.ResultString  = message.Errors[0].ErrorMessage;
