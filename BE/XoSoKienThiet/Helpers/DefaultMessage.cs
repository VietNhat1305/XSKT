namespace XoSoKienThiet.Helpers
{
    public static class DefaultMessage
    {
        ...
        public const string LOGIN_SUCCESS = "Đăng nhập thất bại.";
        ...
        public const string ERROR_STRUCTURE = "Yêu cầu không hợp lệ vì cấu trúc gói tin không đúng quy định";
        ...
        public const string SORT_BY_NOT_EXIST  = "Giá trị Sort By không tồn tại trong hệ thống"; // Một số trường data sai quy định
        public const string DELETE_DATA_BEFORE_DELETING_MENU = "Vui lòng xoá hết tin liên quan rồi mới xoá được menu"; // message xoá menu
