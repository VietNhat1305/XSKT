...
namespace XoSoKienThiet.Controllers.NghiepVu
{
    ...
    //[Authorize]
    public class LinkController : DefaultReposityController<LinkModel>
    {
        private readonly ILinkService _service;
        private DataContext _dataContext;
        private static string NameCollection = DefaultNameCollection.LINK;
        public LinkController(DataContext context, ILinkService service) : base(context, NameCollection)
        {
            _service = service;
        ...
        [HttpPost]
        [Route("create")]
        public async Task<IActionResult> Create([FromBody] LinkModel file)
        {
            try
            {
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IActionResult> Update([FromBody] LinkModel model)
        {
            try
            {
