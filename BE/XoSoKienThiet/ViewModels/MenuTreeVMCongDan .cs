...
{
    public class MenuTreeVMCongDan
    {
     
        public MenuTreeVMCongDan(MenuCongDan model)
        {
            this.Id = model.Id;
        ...
        public List<MenuTreeVMCongDan> Children { get; set; }
    ...
    public class MenuTreeVMCongDanGetAll
    {
        public MenuTreeVMCongDanGetAll(MenuCongDan model)
        {
            this.Id = model.Id;
