...
export default {
  ...
  created() {
    const user = {
      ...
      permissions: [
        'manage-TAIKHOAN-628cb1e38c3f301c2b394361', 
        'create-TAIKHOAN-628cb1e38c3f301c2b394361',
        'update-TAIKHOAN-628cb1e38c3f301c2b394361',
        'delete-TAIKHOAN-628cb1e38c3f301c2b394361'
      ]
    }
  },
  methods: {
    ...
    async handleDelete() {
      if (this.model._id != 0 && this.model._id != null && this.model._id) {
        await this.$store.dispatch("userStore/delete",{_id :  this.model._id}).then((res) => {
          if (res.code===0) {
            this.fnGetList();
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-8">
                <div class="text-sm-end">
                  <b-button
                      v-if="$can('manage-TAIKHOAN-628cb1e38c3f301c2b394361') || $can('create-TAIKHOAN-628cb1e38c3f301c2b394361')"
                      type="button"
                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template v-slot:cell(process)="data">
                      <button
                          v-if="$can('manage-TAIKHOAN-628cb1e38c3f301c2b394361') || $can('update-TAIKHOAN-628cb1e38c3f301c2b394361')"
                          type="button"
                          size="sm"
                      ...
                      <button
                          v-if="$can('manage-TAIKHOAN-628cb1e38c3f301c2b394361') || $can('delete-TAIKHOAN-628cb1e38c3f301c2b394361')"
                          type="button"
                          size="sm"
                          class="btn btn-outline btn-sm"
