...
export default {
 ...
 //    this.GetListParent();
     ...
     const user = {
      ...
      permissions: [
        'manage-MENU-628cb1f38c3f301c2b394364', 
        'create-MENU-628cb1f38c3f301c2b394364',
        'update-MENU-628cb1f38c3f301c2b394364',
        'delete-MENU-628cb1f38c3f301c2b394364'
      ]
    }
  },
  methods: {
    ...
    async handleDelete() {
      if (this.model._id != 0 && this.model._id != null && this.model._id) {
        await this.$store.dispatch("menuStore/delete", {_id :this.model._id}).then((res) => {
          if (res.code === 0) {
            this.GetTreeList();
    ...
    async handleUpdate(id) {
      await this.$store.dispatch("menuStore/getById", {_id : id}).then((res) => {
        if (res.code === 0) {
            ...
            >
              ...
              <div class="row card-baiviet">
                    ...
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowTieuDe" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowMoTa" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowTrichYeu" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowKyHieu" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowNgayXuatBan" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowAnhDaiDien" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowNgayKy" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowNoiDung" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                    <div class="mb-1 col-md-4">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-1">
                          <switches class="mt-2 mb-0"  v-model="model.isShowTepTin" type-bold="false" color="success" ></switches>
                        </div>
                      </div>
                    </div>
                  </div>
              <div class="row card-baiviet">
                ...
                <div class="mb-1 col-md-4">
                  <label class="text-left">Trích yếu</label>
                  <div class="col-md-3">
                    <div class="form-group mb-1">
                ...
                <div class="mb-1 col-md-4">
                  <label class="text-left">Ngày xuất bản</label>
                  <div class="col-md-3">
                    <div class="form-group mb-1">
                ...
                <div class="mb-1 col-md-4">
                  <label class="text-left"> Ảnh bài đăng</label>
                  <div class="col-md-3">
                    <div class="form-group mb-1">
                ...
                <div class="mb-1 col-md-4">
                  <label class="text-left">Ngày kí</label>
                  <div class="col-md-3">
                    <div class="form-group mb-1">
                ...
                <div class="mb-1 col-md-4">
                  <label class="text-left">Tệp tin </label>
                  <div class="col-md-3">
                    <div class="form-group mb-1">
              ...
              <div class="text-end pt-2 mt-3">
                ...
                <b-button 
                  v-if="model._id || $can('manage-MENU-628cb1f38c3f301c2b394364') || $can('delete-MENU-628cb1f38c3f301c2b394364')" 
                  type="button" 
                  variant="danger" 
                  class="ms-1"
                ...
                <b-button 
                  v-if="$can('manage-MENU-628cb1f38c3f301c2b394364') || $can('create-MENU-628cb1f38c3f301c2b394364')" 
                  type="submit" 
                  variant="success" 
