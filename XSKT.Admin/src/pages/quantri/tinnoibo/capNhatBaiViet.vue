...
import {contentNoiBoModel} from "../../../models/contentNoiBoModel";
...
export default {
  ...
  page: {
    title: "Cập nhật bài viết nội bộ",
  ...
  data() {
    return {
      ...
      modelContentNoiBo: contentNoiBoModel.baseJson(),
  ...
  methods: {
    ...
    RemoveTree(node, instanceId) {
      let value = this.modelContentNoiBo.menu?.find(x => x.id == node.id);
      if (value != null) {
        this.modelContentNoiBo.menu= this.modelContentNoiBo.menu.filter(x => x.id != value.id);
        // console.log("DELETE",  this.listMenu )
      }
    },
    AddTree(node, instanceId) {
      let index = this.modelContentNoiBo.menu?.findIndex(x => x.id == node.id);
      if (index == -1 || index == undefined) {
        if (!this.modelContentNoiBo.menu){
          this.modelContentNoiBo.menu= [];
        }
      //  console.log("LOG ADD NODE : ", this.node)
        this.modelContentNoiBo.menu.push(node);
    ...
    async handleUpdate() {
      await this.$store.dispatch("contentNoiBoStore/getById", {"_id" : this.$route.params.id}).then((res) => {
        if (res.code===0) {
          console.log(res)
          this.modelContentNoiBo = contentNoiBoModel.fromJson(res.data);
          console.log("LOG MENU : ", this.modelContentNoiBo)
          // if(res.data.ngayKyShow!=null){
          //   this.modelContentNoiBo.ngayKy=res.data.ngayKyShow
          // }
          // if(res.data.ngayKyShow==""){
          //   this.modelContentNoiBo.ngayKy=null
          // }
          // else {
          //   this.modelContentNoiBo.ngayKy=null
          // }
    ...
    async handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        // if (this.modelContentNoiBo.ngayKy != null) {
        //   const formattedDate = this.formatDate(this.modelContentNoiBo.ngayKy);
        //   this.modelContentNoiBo.ngayKy = formattedDate
        // } else {
        //   this.modelContentNoiBo.ngayKy = null
        // }
        await this.$store.dispatch("contentNoiBoStore/update", contentNoiBoModel.toJson(this.modelContentNoiBo)).then((res) => {
          if (res.code === 0) {
            this.GetTreeList();
            this.showModal = false;
            this.modelContentNoiBo = contentNoiBoModel.baseJson();
            this.modelContentNoiBo.noiDung='';
            this.$router.push('/tin-noi-bo')
            // sau khi update chỗ push này truyền vào router danh sách bài viết vừa cập nhât
          }
    ...
    uploadFile(files,response) {
      ...
      if (response.code == 0){
        this.modelContentNoiBo.files.push({
      ...
      console.log('log model file', this.modelContentNoiBo.files)
    ...
    removeThisFile(files, error, xhr) {
      ...
      if (fileCongViec.data && fileCongViec.data.fileId) {
        ...
        let resultData = this.modelContentNoiBo.files.filter(x => {
          return x.fileId != idFile;
        })
        this.modelContentNoiBo.files = resultData;
        console.log('log model file remove', this.modelContentNoiBo.files)
      }
    ...
    async upload() {
      if (this.modelContentNoiBo != null && this.modelContentNoiBo.fileImage != null)
      {
        console.log("LOG this.modelContentNoiBo : ", this.modelContentNoiBo)
        axios.post(`${process.env.VUE_APP_API_URL}filesminio/delete/${this.modelContentNoiBo.fileImage.fileId}`).then((response) => {
          this.modelContentNoiBo.files = null;
          console.log('log model file remove', this.modelContentNoiBo.files);
        }).catch((error) => {
          // Handle error here
          console.error('Error deleting file:', error);
    ...
    deleteImage(){
      if (this.modelContentNoiBo != null && this.modelContentNoiBo.fileImage != null)
      {
        console.log("LOG this.modelContentNoiBo : ", this.modelContentNoiBo)
        axios.post(`${process.env.VUE_APP_API_URL}filesminio/delete/${this.modelContentNoiBo.fileImage.fileId}`).then((response) => {
          this.modelContentNoiBo.fileImage = null;
          console.log('log model file remove', this.modelContentNoiBo.files);
        }).catch((error) => {
          // Handle error here
          console.error('Error deleting file:', error);
          ...
          <div class="row" ref="formContainer">
            <div class="content-lis col-md-6">
              <div class="cs-title-box">
                <div class="cs-title py-2">
                  <span class="fw-normal font-size-13">THÔNG TIN BÀI VIẾT NỘI BỘ</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="mb-2">
                ...
                <treeselect
                    v-model="modelContentNoiBo.menu"
                    v-on:select="AddTree"
                    ...
                    :class="{'is-invalid':submitted && $v.modelContentNoiBo.menu.$error,}"
                >
                ...
                <div
                    v-if="submitted && !$v.modelContentNoiBo.menu.required"
            ...
            <div class="col-12">
              <div class="mb-2">
                ...
                <span style="color: red">&nbsp;*</span>
                <input
                    v-model="modelContentNoiBo.name"
                    id="percent"
                    type="text"
                    class="form-control"
                    :class="{
                      'is-invalid':
                        submitted && $v.modelContentNoiBo.name.$error,
                    }"
                />
                <div
                    v-if="submitted && !$v.modelContentNoiBo.name.required"
                    class="invalid-feedback"
                >
            ...
            <div class="col-12">
              <div class="form-check form-switch mb-2">
                ...
                <input
                    v-model="modelContentNoiBo.isPublic"
            ...
            <div class="col-3">
              <div class="mb-2 ">
                ...
                <date-picker v-model="modelContentNoiBo.ngayXuatBan"
                  format="DD/MM/YYYY"
                  id="percent"
            ...
            <div class="col-3">
              <div class="mb-2 ">
                ...
                <date-picker v-model="modelContentNoiBo.ngayKy"
                  format="DD/MM/YYYY"
                  id="percent"
             ...
             <div class="col-6">
              <div class="mb-2 ">
                ...
                <input
                    v-model="modelContentNoiBo.moTa"
                    id="percent"
                    type="text"
                    class="form-control"
            ...
            <div class="col-4">
              <div class="mb-2 ">
                ...
                <input
                    v-model="modelContentNoiBo.trichYeu"
                    id="percent"
                    type="text"
                    class="form-control"
            ...
            <div class="col-4">
              <div class="mb-2 ">
                ...
                <input
                    v-model="modelContentNoiBo.soKiHieu"
                    id="percent"
                    type="text"
                    class="form-control"
                />
            ...
            <div class="col-4">
              ...
              <template  v-if="modelContentNoiBo.fileImage" >
                <a
                    class="ml-25"
                    :href="`${urlFile}/${modelContentNoiBo.fileImage.fileId}`"
                ><i
                    :class="`${getColorWithExtFile(modelContentNoiBo.fileImage.ext)} me-2 ${getIconWithExtFile(modelContentNoiBo.fileImage.ext)}`"
                ></i>{{modelContentNoiBo.fileImage.fileName }}</a>
                <b-button
                    variant="flat-danger"
                    class="btn-icon"
                    @click="deleteImage()"
            ...
            <div>
            <ckeditor-nuxt v-model="modelContentNoiBo.noiDung"
                :config="editorConfig" :class="{'is-invalid':submitted && $v.modelContentNoiBo.noiDung.$error,}">

              </ckeditor-nuxt>
              <div
                  v-if="submitted && !$v.modelContentNoiBo.noiDung.required"
                  class="invalid-feedback"
              >
                Nội dung bài viết không được trống.
              </div>
            </div>
            <template  v-if="modelContentNoiBo.files.length > 0" >
              <div v-for="(file,index) in modelContentNoiBo.files" :key="index">
                <a
                    class="ml-25"
