...
import {bienBanXoSoModel} from "@/models/bienBanXoSoModel";
export default {
  page: {
  ...
  data() {
    return {
      ...
      submitted: false,
      modelSlider: bienBanXoSoModel.baseJson(),
      listRole: [],
  ...
  created() {
    const user = {
      ...
      permissions: [
        'manage-BIENBAN-656442f5106c43a04bbadfaa', 
        'create-BIENBAN-656442f5106c43a04bbadfaa',
        'update-BIENBAN-656442f5106c43a04bbadfaa',
        'delete-BIENBAN-656442f5106c43a04bbadfaa'
      ]
    }
  },
  watch: {
    showModalSlider(status) {
      if (status == false) this.modelSlider = bienBanXoSoModel.baseJson() ;
    },
    showDeleteModal(val) {
      if (val == false) {
        this.model.id = null;
  ...
  methods: {
      ...
      if (this.$v.$invalid) {
        ...
        if (
          ...
          if (this.modelSlider == null || (this.modelSlider != null && this.modelSlider.file == null)) {
            ...
            await this.$store.dispatch("bienBanXoSoStore/update", this.modelSlider).then((res) => {
              if (res.code === 0) {
                this.showModalSlider = false;
                this.$refs.tblList.refresh();
                this.modelSlider = bienBanXoSoModel.baseJson();
              }
              this.$store.dispatch("snackBarStore/addNotify", {
                message: res.message,
                code: res.code,
          ...
          if (this.modelSlider == null || (this.modelSlider != null && this.modelSlider.file == null)) {
            ...
            await this.$store.dispatch("bienBanXoSoStore/create", this.modelSlider).then((res) => {
              if (res.code === 0) {
                this.fnGetList();
                this.showModalSlider = false;
                this.model={}
    ...
    async handleDelete() {
      if (this.modelSlider._id != 0 && this.modelSlider._id != null && this.modelSlider._id) {
        await this.$store.dispatch("bienBanXoSoStore/delete",{_id :  this.modelSlider._id}).then((res) => {
          if (res.code===0) {
            this.fnGetList();
            this.modelSlider = bienBanXoSoModel.baseJson();
    ...
    async handleUpdate(id) {
      await this.$store.dispatch("bienBanXoSoStore/getById", {_id : id}).then((res) => {
        if (res.code===0) {
          console.log(res)
          this.modelSlider = bienBanXoSoModel.toJson(res.data);
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("bienBanXoSoStore/getPagingParams", params)
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-8">
                <div class="text-sm-end">
                  <b-button
                      v-if="$can('manage-BIENBAN-656442f5106c43a04bbadfaa') || $can('create-BIENBAN-656442f5106c43a04bbadfaa')"
                      type="button"
                      class="btn cs-btn-primary btn-rounded mb-2 me-2"
                      size="sm"
                      @click="showModalSlider = true"
                  >
                    <i class="mdi mdi-plus me-1"></i> Thêm biên bản
                  </b-button>
                  <b-modal
                  ...
                  >
                    ...
                    >
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-2">
                            <label class="text-left mb-0">Tên biên bản</label>
                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template v-slot:cell(process)="data">
                      <button
                          v-if="$can('manage-BIENBAN-656442f5106c43a04bbadfaa') || $can('update-BIENBAN-656442f5106c43a04bbadfaa')"
                          type="button"
                          size="sm"
                      ...
                      <button
                          v-if="$can('manage-BIENBAN-656442f5106c43a04bbadfaa') || $can('delete-BIENBAN-656442f5106c43a04bbadfaa')"
                          type="button"
                          size="sm"
                          class="btn btn-outline btn-sm"
