...
<template>
  <div class="container-fluid p-0 bg-login">
    <div class="row g-0 justify-content-end">
      <div class="col-xl-6 col-md-6 col-12 px-md-2 login-box">
...
.bg-login {
  background: url("~@/assets/images/bg-login1.jpg");
