...
export default {
  ...
  methods:{
    ...
    async handleSubmit(e) {
      ...
      this.submitted = true;
      this.$v.$touch();
      console.log('loggggg',this.model)
    ...
    getID(){
      ...
      console.log('log idstore', this.modelpass.userName)
      this.modelpass.id=JSON.parse(idstore)?.id;
      console.log('log idstore', this.modelpass.id)
    ...
    uploadFile(files,response) {
      ...
      if (response.code == 0){
        this.model.avatar=fileSuccess.fileId;
      }
      console.log('log model avatar', this.model.avatar)
      ...
      <div class="col-xl-4">
        <div class="card overflow-hidden">
            ...
            <div class="row">
              <div class="col-7">
                <div class="text-primary p-1">
                  <h5 class="">Chào mừng bạn đã trở lại</h5>
                </div>
              </div>
          ...
          <div class="card-body pt-0">
            <div class="row">
              <div class="col-sm-12">
                <div class="profile-user-wid">
                  <div v-if="modelView.avatar != null">
                    <b-img
                        :src=" url + `${modelView.avatar}`"
                        alt
                ...
                <h5 class="font-size-15 text-truncate mt-2">{{modelView.fullName}}</h5>
...
<!--            >Hi I'm Cynthia Price,has been the industry's standard dummy text To an English person, it will seem like simplified English, as a skeptical Cambridge.</p>-->
            <div class="table-responsive ">
              <table class="table table-nowrap mb-0">
                <tbody>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #05912a !important;border: 1px solid #000; color: #fff !important;">Tên tài khoản :</th>
                  <td class="fw-bold">{{modelView.userName}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #05912a !important;border: 1px solid #000; color: #fff !important;">Họ và tên :</th>
                  <td class="fw-bold" style="background-color: #fff !important;">{{modelView.fullName}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #05912a !important;border: 1px solid #000; color: #fff !important;">E-mail :</th>
                  <td class="fw-bold">{{modelView.email}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #05912a !important;border: 1px solid #000; color: #fff !important;">Số điện thoại :</th>
                  <td class="fw-bold" style="background-color: #fff !important;">{{modelView.phone}}</td>
                </tr>
<!--                <tr>-->
            ...
            <div class="card-body">
              <b-tabs justified nav-class="nav-tabs-custom" content-class="p-3 text-muted">
                <b-tab active>
                  ...
                  <div class="text-end">
                    <b-button type="submit" variant="primary" class=" align-middle me-2 cs-bg-primary" style="width: 80px; border: none;" size="sm"
                              @click="handleSubmit"
                    >
                      Cập nhật
                    </b-button>
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <input type="hidden" v-model="modelpass._id"/>
                          <input
                              id="name"
                              type="text"
                              class="form-control"
                      ...
                      <div class="text-end pt-2 mt-3">
                        <b-button  type="submit" variant="primary" class="ms-1 cs-bg-primary" style="border: none;" size="sm"><i
                            class="bx bx-check-double font-size-16 align-middle me-2"
                        ></i> Lưu
                        </b-button>
                      </div>
