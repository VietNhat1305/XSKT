                        ...
                        <div class="col-6">
                          <div class="mb-2">
                            ...
                            <multiselect
                             ...
                             :class="{
                                                  'is-invalid':
                                                (submitted  && $v.modelSlider.loaiAnh.$error) ,
                                                }"
                            >
                            </multiselect>
                            <div
                                v-if="submitted && !$v.modelSlider.loaiAnh.required"
                                class="invalid-feedback"
                            >
                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template v-slot:cell(file)="data">
                      <div v-for="(items, index) in data.item.file" :key="index">
                        <b-card-img
                          :src="url + items.fileId"
                    ...
                    <template v-slot:cell(loaiAnh)="data">
                        {{ data.item.loaiAnh.name }}
                    </template>
