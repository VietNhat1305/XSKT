...
export default {
  ...
  created() {
    const user = {
      ...
      permissions: [
        'manage-VAITRO-6546568d181c99b8823f7285', 
        'create-VAITRO-6546568d181c99b8823f7285',
        'update-VAITRO-6546568d181c99b8823f7285',
        'delete-VAITRO-6546568d181c99b8823f7285',
        'detail-VAITRO'
      ]
    }
  },
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-8">
                <div class="text-sm-end">
                  <b-button 
                    v-if="$can('manage-VAITRO-6546568d181c99b8823f7285') || $can('create-VAITRO-6546568d181c99b8823f7285')"
                    type="button" 
                  ...
                  >
                    ...
                    <template v-slot:cell(listAction)="data">
                      <router-link :to='`/vai-tro/thiet-lap-quyen/${data.item._id}`'>
                        <b-button
                            v-if="data.item.listAction.length > 0 "
                    ...
                    <template v-slot:cell(process)="data">
                      <button
                          v-if="$can('manage-VAITRO-6546568d181c99b8823f7285') || $can('detail-VAITRO')"
                          type="button"
                          size="sm"
                      ...
                      <button
                          v-if="$can('manage-VAITRO-6546568d181c99b8823f7285') || $can('update-VAITRO-6546568d181c99b8823f7285')"
                          type="button"
                          size="sm"
                          class="btn btn-outline btn-sm"
                      ...
                      <button
                          v-if="$can('manage-VAITRO-6546568d181c99b8823f7285') || $can('delete-VAITRO-6546568d181c99b8823f7285')"
                          type="button"
                          size="sm"
                          class="btn btn-outline btn-sm"
