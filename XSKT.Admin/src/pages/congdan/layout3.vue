      ...
      <nav class="navbar pd-0 bg-menu" id="navbar"
        ...
        <div class="cs-navbar-header menu">
          ...
          <ul
            ...
            >
            <img src="@/assets/images/Logo copy.png" alt="" style="width: 40px;">
            ...
            <div class="dangnhap" style="padding: 8px 5px;">
              <button type="button"
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="text-light">
                ...
                <p>Địa chỉ: {{ this.lienHe.diaChi }}</p>
                <p>Mã số thuế: {{ this.lienHe.maSoThue }}</p>
                <p>Điện thoại: {{ this.lienHe.sdt }} - Fax: {{ this.lienHe.fax }}</p>
                <p>{{ this.lienHe.nguoiBienTap }}</p>
              </div>
            </div>
          </div>
        </div>
