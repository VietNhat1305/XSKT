          ...
          <div class="wrap-main">
            <div class="row content">
                <div class="col-md-4">
                    ...
                    style="width: 100%; height: 600px; border-radius: 10px; border: 1px solid #05912a;
                ...
                <div class="col-md-8 col-sm-12 row mt-3">
                  <div class="col-md-12">
                    <b-carousel id="carousel-3"
                      ...
                      <b-carousel-slide v-for="(item, index) in tinnoibat" :key="index"
                        ...
                        >
                          <div class="carousel-name">
                            <a href="">
                              <h4 style="color: #ec008b; font-weight: bold;">{{ item.name }}  </h4>
                              <p style="
                                    color: #000;
                                    font-size: 15px;
                                        ...
                                        <div class="row card-sukien mb-2">
                                            ...
                                            <div v-if="!items.fileImage">
                                                ...
                                                <img
                                                    ...
                                                    alt="Không có ảnh"
                                                    class="rounded-0"
                                                    style="height: 120px; padding: 10px; width: 150px; padding: 10px;"
                                                >
                                                </div>
                                            </div>
                                            <div v-else>
            ...
            <!-- VIDEO -->
            <div class="row mt-4" style="border-top: 2px solid #ec008b;">
...
#carousel-3 .carousel-name {
  background-color: #faf1508a;
  padding: 10px;
  transform: translateY(40px);
  opacity: 0;
}
#carousel-3:hover .carousel-name{
  transform: translateY(0px);
  transition: 0.5s;
	opacity: 1;
}
