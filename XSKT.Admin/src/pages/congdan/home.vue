...
<template>
  <Layout>
    <section class="section pt-4" id="home">
      <div class="row header" style="margin-top: 226px;">
        <div class="col-12">
          <div class="card">
            <div class="">
              <b-carousel id="carousel-fade" style="text-shadow: 0px 0px 2px #000">
                <b-carousel-slide v-for="slide in listFileSilder" :key="slide._id" :img-src="apiView + slide.file.fileId">
                </b-carousel-slide>
              </b-carousel>
            </div>
          </div>
      ...
      <div class="container" style="padding: 0 50px;">
          ...
          <div class="wrap-main">
            <div class="row">
              ...
              <div class="col-xl-8 col-lg-12">
                <div>
                  <h3 class="fw-bold name-bienban" style="color: #ec008b; text-align: center; ">Biên bản kết quả xổ số
                  </h3>
                </div>
                <div class="row" style="text-align: center;">
                  <div class="col-md-3 col-sm-3 col-xs-3 bienban" v-for="(item, index) in this.bienban" :key="index"
                ...
                <div >
                  <p class="img-kq" v-if="ketquaxoso">
                  <b-card-img :src="apiView + ketquaxoso.file.fileId" class="rounded-0" :height="700"
                  :width="250"></b-card-img>
                </p>
                </div>

                <div v-for="(item, index) in imagehome" :key="index" class="sample" style="margin-top: 20px;">
                ...
                <div class="sample" style="margin-top: 20px;">
                  <div style="padding: 10px;">
                    ...
                    <p class="fs-15">+ Số 01, đường Duy Tân, phường Mỹ Phú, TP Cao Lãnh, tỉnh Đồng Tháp. ĐT: 02773.861746
                    </p>
                    <p class="fs-15">+ Số 03, đường Phạm Đình Toái, phường Võ Thị Sáu, quận 3, Tp.Hồ Chí Minh. ĐT:
                      0286.6823966</p>
                  </div>
                </div>
                ...
                <div class="sample" style="margin-top: 20px;">
                  <div class="mb-3" style="padding-top: 20px;">
                    ...
                    <div class="row" style="padding: 10px; text-align: center;">
                      <div class="col-md-4 col-sm-4" v-for="(item, index) in diemban" :key="index"
                        style="color: #b30d0a; font-size: 15px;">
              ...
              <div class="col-xl-4 col-lg-12">
                ...
                <!-- <div class="input-group rounded">
                  <div class="title-search">
                    <h3 class="fw-bold">Tra cứu kết quả xổ số</h3>
                  </div>
                  <input type="search" class="form-control rounded" placeholder="Nhập 6 số" aria-label="Search" aria-describedby="search-addon" />
                ...
                <div class="card-card">
                  <div class="">
                    <div class="card-title-cs bg-menu">Giới thiệu</div>
                ...
                <!-- SUB VIDEO -->
                <div class="row mb-4">
                  <div class="col-6 card-card" v-for="(item, index) in video" :key="index">
                    <div class="ratio ratio-16x9">
                ...
                <div class="img-kq" v-for="(item, index) in lienket" :key="index">
                  <a target="_blank" :href="`${item?.link}`"><img :src="`${url}/${item.file.fileId}`"
                      :alt="`${item.moTa}`"></a>
                </div>
              </div>
            </div>
        ...
        <div class="row block-post" v-for="(item, index) in listtin" :key="index">
          <div class="col-md-12 col-sm-6">
            <router-link :to="{
              path: `/tin-hoat-dong/${item.id}`,
            }">
              <div class="cs-title-box">
                <div class="cs-title py-2">
                  <i class="mdi mdi-star ic-item"></i>
                  <span class="" style="color: #fff;">{{ item.name }}</span>
                </div>
              </div>
            </router-link>
          </div>
          <div class="row">
            <div class="col-md-6 block-left mb-2">
                    ...
                    <div class="img-news pd-2">
                      <div v-if="!items.fileImage">
                        <div class="float-left img-logo" style="text-align: center;">
                          <img src="@/assets/images/logoXSKTDT.png" alt="Không có ảnh" class="rounded-0"
                            style="height: 300px; padding: 10px;">
                        </div>
                      </div>
                      <div v-else>
                        <b-card-img :src="apiView + items.fileImage.fileId" class="rounded-0 img-tintuc" :height="400"
                          :width="250"></b-card-img>
                      </div>
                    </div>
                    <div class="title-news pt-3">
                      <a href="">
                        <h4 style="color: #bb1a78; font-weight: bold;">{{ items.name }} </h4>
                        <p style="
                          color: #000;
                ...
                <div v-if="index !== 0">
                  <router-link :to="{
                    ...
                    <div class="row card-sukien mb-2">
                      <div class="col-md-4 col-sm-4 img-news pd-2">
                        <div v-if="!items.fileImage">
                          <div class="float-left img-logo" style="text-align: center;">
                            <img src="@/assets/images/logoXSKTDT.png" alt="Không có ảnh" class="rounded-0"
                              style="height: 150px; padding: 10px; width: 150px; padding: 10px;">
                          </div>
                        </div>
                        <div v-else>
                          <b-card-img :src="apiView + items.fileImage.fileId" class="rounded-0 img-tintuc" :height="150"
                            :width="250"></b-card-img>
                        </div>
                      </div>
                      <div class="col-md-8 col-sm-8 title-news">
                        <a href="">
                          <h4 style="color: #bb1a78; font-weight: bold;">{{ items.name }} </h4>
                          <p style="
                              color: #000;
