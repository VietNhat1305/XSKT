...
<template>
  <header id="page-topbar" >
    <div class="navbar-header" style="background: #05912a">
      <div class="d-flex">
        <!-- LOGO -->
      ...
      <div class="d-flex align-items-center" style="height: 60px !important;">
        ...
        >
          <template class="dis" v-slot:button-content>
            <span>
